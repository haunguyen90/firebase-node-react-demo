...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'prezentvrweb.data';
    var REMOTE_PACKAGE_BASE = 'prezentvrweb.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 73446136;
      var PACKAGE_UUID = 'df7b7241-929d-419c-82e1-59cf099cbeb6';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 68357087, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(68357087, 68357106, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(68357106, 68371263, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(68371263, 72543539, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(72543539, 73418511, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(73418511, 73446136, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_prezentvrweb.data');

    };
    Module['addRunDependency']('datafile_prezentvrweb.data');
