...
import UploadModelModal from './UploadModelModal.js';
import {getDownloadURL} from '~/lib/firebaseHelpers/storageHelper.js';

class ModelComponent extends SlideComponent {
  constructor(props){
    super(props);
  ...
  render(){
    ...
    return (
      <div className="slide-component model-component row">
        <Col sm={2}>
          <FormGroup controlId={"componentModelPic-" + keyId}>
            <ControlLabel>MODEL</ControlLabel>
            <Thumbnail className="model-thumbnail" href="#" alt="171x180" src={ENUMS.MISC.NO_IMAGE_AVAILABLE} />
            <div className="box__input">
              <Button className="uploadButton" bsStyle="primary" onClick={this.showModelModal.bind(this)} block>
        ...
        <Col sm={10}>
          <FormGroup controlId={"componentModelText-" + keyId}>
            <Confirm
...
export default withRouter(ModelComponent, {withRef: true});
